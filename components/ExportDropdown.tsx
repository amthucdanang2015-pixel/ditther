            ...
            <div className="absolute top-[50px] right-4 z-[101] w-[340px] bg-[#1a1a1d] border border-white/5 rounded-[24px] p-3 shadow-2xl flex flex-col gap-2">
                ...
                <div className="relative">
                    <button 
                        ...
                        className="w-full flex items-center justify-between bg-[#242427] hover:bg-[#2a2a2d] transition rounded-[16px] px-4 py-3.5 text-[14px]"
                    >
                        ...
                        <div className="absolute top-full left-0 right-0 mt-2 bg-[#242427] border border-white/5 rounded-[16px] p-1.5 z-20 shadow-xl flex flex-col gap-0.5">
                            {resolutions.map(r => (
                                <button 
                                    ...
                                    className={`w-full flex items-center justify-between text-left px-3 py-2.5 rounded-[12px] text-[14px] transition ${resolution === r ? "text-white" : "text-white/60 hover:text-white hover:bg-white/5"}`}
                                >
                                    {r}
                        ...
                        <div className="absolute top-full left-0 right-0 mt-2 bg-[#242427] border border-white/5 rounded-[16px] p-1.5 z-20 shadow-xl flex flex-col gap-0.5">
                            {formats.map(f => (
                                <button 
                                    ...
                                    className={`w-full text-left px-3 py-2.5 rounded-[12px] text-[14px] transition ${format === f ? "text-white" : "text-white/60 hover:text-white hover:bg-white/5"}`}
                                >
                                    {f}
                                </button>
                            ))}
                ...
                <div className="flex items-center gap-2 mt-2">
                    <button className="flex-1 flex items-center justify-center gap-2 bg-[#242427] hover:bg-[#2a2a2d] border border-white/5 transition rounded-full py-3.5 text-[14px] text-white">
                        <Share2 size={16} />
                        Share
                    </button>
                    <button 
                        onClick={() => onExport(format, resolution)}
                        className="flex-1 flex items-center justify-center gap-2 bg-[#242427] hover:bg-[#2a2a2d] border border-white/5 transition rounded-full py-3.5 text-[14px] text-white">
                        <Download size={16} />
                        Export
                    </button>
                </div>
